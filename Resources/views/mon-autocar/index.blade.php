    ...
    <div class="bg-white h-full w-full h-screen flex flex-col justify-between" style="font-family: 'Lato', sans-serif;">
        <div class="max-w-7xl w-full mx-auto pt-16 bg-gray-200 px-8 pb-16">
            ...
            <div class="border border-black p-4">
                ...
                @foreach(($devis->data['trajets'] ?? []) as $index => $trajet)
                    ...
                    <div class="border border-black mt-1 p-2 text-md space-y-4">
                        ...
                        <div class="font-extrabold ">
                            <span class="underline">Nombre de personnes</span>
                            <span class="ml-1"> : {{ $trajet['aller_pax'] }}</span>
                    ...
                    <div>
                        <livewire:crmautocar::mon-autocar-recap-price :devis="$devis" :trajet-id="$index" :brand="$brand"/>
                    </div>
                ...
                <div class=" mb-12">
                    <div class=" text-xl font-extrabold uppercase text-center mt-2 mb-2 border border-black bg-gray-400 py-2">
                        Total - prix forfaitaire t.t.c @marge($price->getPriceTTC())€ <span class="text-sm"> (tva @marge($price->getTauxTVA()) % incluse)</span>
                    </div>
                </div>
            ...
            <div class="mt-4">
                ...
                <span>
                        Ce devis est établie en focntion de la régementation social des transports routiers de voyageurs en vigeur. Tout
                        Changement de programme et/ou d'horaire risque d'entrainer le nom-respect de cette réglementation et
                        engagerait votrez responsibilité. N'hesitez pas à nous contacter.
                        Ce devis ne costitute ni une option, ni une réservation. Pour réserver, merci de bien vouloir nous contacter ou nous
                        retourner ce document signé, en précisant les informations suivantes:<br>
                        -Non et téléphone du responsable :<br>
                        -Nom et adresse de facturation :<br>
                        -Acompagné d'un acompte de 30% soit: @marge($price->getPriceTTC() * 0.30)€ à régler par chéque ou par virement IBAN: FR76 1170 6000 1902 6542<br><br>
                        Restant à votre disposition pour tous renseignement complemantaires,<br>
                        Nous vous prions de croire, à l'assurance de nos sentiment les meilleurs
                    </span>
            </div>
            <div class="grid grid-cols-2 mt-4">
                <div class="font-extrabold flex flex-col">
                    <span>BON POUR ACCORD le :</span>
                    <span>(signature)</span>
                </div>
                <div class="font-extrabold" >
