<div class="box bg-theme-1 p-5 mt-6">
    <div class="pt-3 text-white" x-data="{selected:null}">
        @foreach($this->commercials as $commercial)
            <span class="flex items-center py-2 rounded-md @if($this->commercial_id == $commercial->id) bg-theme-25 @endif pr-4 pl-2 dark:bg-dark-1 font-medium cursor-pointer">
