                ...
                <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                    <div class="report-box zoom-in">
                        <div class="box p-5">
                            ...
                            <div class="text-3xl font-medium leading-8 mt-6">48 956€</div>
                ...
                <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                    <div class="report-box zoom-in">
                        <div class="box p-5">
                            ...
                            <div class="text-3xl font-medium leading-8 mt-6">15 956€</div>
                ...
                <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                    <div class="report-box zoom-in">
                        <div class="box p-5">
                            ...
                            <div class="text-3xl font-medium leading-8 mt-6">3 956€</div>
                            <div class="text-base text-gray-600 mt-1">Avoir</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="intro-y overflow-auto lg:overflow-visible mt-8 sm:mt-0">
                <table class="table table-report sm:mt-2">
                    ...
                    @foreach($invoices as $invoice)
                        <livewire:crmautocar::invoices-list-item :ref="$invoice->id" :invoice="$invoice" />
                    @endforeach
                    </tbody>
                </table>
            </div>
