<div class="{{$class}}">
    ...
    @if(!$sidebar)
        ...
        <div class="justify-self-end text-sm flex-col flex my-8 grid justify-items-stretch">
            @if ($devis->data['inclus_peages'] ?? '' || $devis->data['inclus_parking'] ?? '' || $devis->data['inclus_hebergement'] ?? '' || $devis->data['inclus_repas_chauffeur'] ?? '')
                <span>
    ...
    @else
        <livewire:devis-client.accepte-devis/>
    @endif
</div>
