<tr
    @if ($proformat->hasCancel()) class="bg-red-100"
    @elseif($validate ?? false)
        class="bg-green-400" @endif>
    ...
    <td class="border-b dark:border-dark-5">
        <div class="flex items-center justify-center space-x-2">
            @if ($editDate ?? false)
                <div class="flex flex-col">
                    <x-basecore::inputs.datetime label="" name="acceptation_date" wire:model="acceptation_date"
                        placeholder="Accepté le" required />
                </div>
    ...
    <td class="border-b dark:border-dark-5">
        @marge($proformat->price->paid())€
    </td>
    <td class="border-b dark:border-dark-5">
        @marge($proformat->price->remainsWithOver())€
    </td>
    <td class="border-b dark:border-dark-5">
