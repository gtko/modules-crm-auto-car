...
@section('content')
    ...
    <div class="bg-white h-full w-full" style="font-family: 'Lato', sans-serif;">
        ...
        <div
            class="bg-gray-200 lg:px-12 pt-4 max-w-7xl mx-auto sm:px-6 lg:px-8 px-4 lg:grid lg:grid-cols-3 lg:gap-4 ">
            <div class="flex-col flex lg:col-span-2">
                ...
                <x-crmautocar::devis-client.cgv
                    class="bg-white border border-2 border-gray-400  lg:mb-6 mb-0 mt-6 p-4 lg:order-5"/>
            </div>
