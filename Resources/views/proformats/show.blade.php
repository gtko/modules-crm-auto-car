                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="logo-name">
                                            <div class="info">
                                                <img class='mb-3'
                                                     src="https://www.centrale-autocars.fr/images/logo-centrale-autocar.png"
                                                     alt="logo">
                                                <p>
                                                    <a href="mailto:{{$proformat->devis->dossier->commercial->email ?? '--'}}">{{$proformat->devis->dossier->commercial->email ?? '--'}}</a>
                                                <p class="mb-0"><a
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="invoice-name text-start" style="padding-bottom: 50px; padding-top: 50px">
                                            <h4 class="name color-white inv-header-1">Facture
                                                proforma @if($price->getPriceTTC() < 0) d'avoir @endif
                                                <br>n°{{$proformat->number}}</h4>
                                            <p class="mb-0">Date
                                                d'émission: {{$proformat->created_at->format('d/m/Y')}}</p>
                                            <p class="mb-0 text-white w-full">Dossier {{$proformat->devis->dossier->ref}}</p>
                                            <p class="mb-0 text-white w-full">Devis {{$proformat->devis->ref}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table class="table invoice-table">
                                            ...
                                            @foreach(($proformat->devis->data['trajets'] ?? []) as $idTrajet => $trajet)
                                                <tr>
                                                    ...
                                                    <td class="text-center text-nowrap">@marge($price->getPriceHT())€
                                                    </td>
                                                    <td class="text-right text-nowrap">@marge($price->getPriceHT())€
                                                    </td>
                                                </tr>
                                            @endforeach
                                            <tr>
                                ...
                                <div class="">
                                    <div class="payment-info text-start mb-30" style="max-width:600px;">
                                        ...
                                        <p class="mb-0">
                                            ...
                                            de nos conditions générales de ventes et donc des conditions d'annulations
                                            ci dessous:
                                        </p>
                                        <ul class="mb-0 important-notes-list-1">
                                            <li>30 % du prix du service si l’annulation intervient à plus de 30 jours
                                                avant le départ
                                            </li>
                                            <li>50 % du prix du service si l’annulation intervient entre 30 et 14 jours
                                                avant le départ
                                            </li>
                                            <li>70 % du prix du service si l’annulation intervient entre 13 et 7 jours
                                                avant le départ
                                            </li>
