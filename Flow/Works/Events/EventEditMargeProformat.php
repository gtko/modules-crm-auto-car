...
class EventEditMargeProformat extends WorkFlowEvent
{

    public function name(): string
    {
        return 'Marge edité sur la réservation';
    }
    ...
    {
        return 'Se déclenche quand la marge de la réservation est édité.';
    }
    ...
    {
        return [
            'proformat' => $flowAttribute->getMarge()->proformat,
            'devis' => $flowAttribute->getMarge()->proformat->devis,
            'dossier' =>  $flowAttribute->getMarge()->proformat->devis->dossier,
            'commercial' => $flowAttribute->getMarge()->proformat->devis->commercial,
            'client' => $flowAttribute->getMarge()->proformat->devis->dossier->client,
        ];
    }
